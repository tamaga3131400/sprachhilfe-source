...
private final class MockEventBus: EventBusProtocol, @unchecked Sendable {
    private(set) var handlers: [UUID: @Sendable (SprachhilfeEvent) async -> Void] = [:]
...
private final class MockTranscriptionPlugin: NSObject, TranscriptionEnginePlugin, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.transcription"
...
private final class MockDownloadedModelPlugin: NSObject, SprachhilfePlugin, PluginDownloadedModelManaging, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.downloaded-models"
...
private final class MockAuthRoleStatusPlugin: NSObject, SprachhilfePlugin, PluginAuthRoleStatusProviding, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.auth-roles"
...
private final class MockDictionaryTermsPlugin: NSObject, TranscriptionEnginePlugin, DictionaryTermsCapabilityProviding, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.dictionary-terms"
...
private final class MockDictionaryBudgetPlugin: NSObject, TranscriptionEnginePlugin, DictionaryTermsBudgetProviding, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.dictionary-budget"
...
private final class MockCatalogTranscriptionPlugin: NSObject, TranscriptionEnginePlugin, TranscriptionModelCatalogProviding, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.catalog"
...
private final class MockStructuredTranscriptionPlugin: NSObject, StructuredTranscriptionEnginePlugin, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.mock.structured"
...
final class ProtocolContractTests: XCTestCase {
    ...
    func testPluginDictionaryTermsNormalizesPromptAndContextTokens() {
        ...
        XCTAssertEqual(
            PluginDictionaryTerms.contextBiasTokens(fromPrompt: "Sprachhilfe, Apple Silicon MLX"),
            ["Sprachhilfe", "Apple", "Silicon", "MLX"]
        )
        XCTAssertEqual(
            PluginDictionaryTerms.prompt(from: ["Sprachhilfe", "MLX"], maxLength: 100),
            "Sprachhilfe, MLX"
        )
    }
