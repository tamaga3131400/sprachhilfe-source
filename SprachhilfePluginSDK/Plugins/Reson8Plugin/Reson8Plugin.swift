...
private final class RawWebSocket: @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: "com.sprachhilfe.reson8", category: "WebSocket")
...
final class Reson8Plugin: NSObject, TranscriptionEnginePlugin, @unchecked Sendable {
    static let pluginId = "com.sprachhilfe.reson8"
    static let pluginName = "Reson8"
    private static let logger = Logger(subsystem: "com.sprachhilfe.reson8", category: "Plugin")
