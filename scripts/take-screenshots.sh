...
# =============================================================================
# Sprachhilfe Screenshot Automation
...
for case let w as NSDictionary in windowList {
    ...
    if owner == "Sprachhilfe" && name == "Settings" {
...
for case let w as NSDictionary in windowList {
    ...
    if owner == "Sprachhilfe" && width == 500 && height == 500 {
        print(w["kCGWindowNumber"] as? Int ?? 0)
        break
    }
}
