...
enum UserDefaultsKeys {
    ...
    static let chatChunkMaxChars = "chatChunkMaxChars"
    ...
    static let graphExtractionProvider = "graphExtractionProvider"
    static let graphExtractionModel = "graphExtractionModel"
    static let graphAutoExtract = "graphAutoExtract"
