...
final class ServiceContainer: ObservableObject {
    ...
    let userDataSyncStore: SprachhilfeUserDataSyncStore
    ...
    let graphExtractionService: GraphExtractionService
    // HTTP API
    ...
    private init() {
        ...
        userDataSyncStore = SprachhilfeUserDataSyncStore(
            dictionaryService: dictionaryService,
            snippetService: snippetService
        )
        ...
        graphExtractionService = GraphExtractionService(documentService: documentService, promptProcessingService: promptProcessingService)
        cloudFolderSyncController = CloudFolderSyncController(syncStore: userDataSyncStore)
        ...
        GraphExtractionService.shared = graphExtractionService
