...
struct GeneralSettingsView: View {
    ...
    private var appVisibilityDescription: LocalizedStringKey {
        ...
        case .menuBar:
            "Sprachhilfe stays in the menu bar and hides its Dock icon while no window is open."
        case .dock:
            "Sprachhilfe stays accessible via the Dock icon."
        case .dockWhileWindowOpen:
            "Sprachhilfe hides both icons until a window opens. To reopen Settings later, launch Sprachhilfe from Spotlight or the Applications folder."
        }
    }
    ...
    var body: some View {
        Form {
            ...
            Section(String(localized: "Startup")) {
                ...
                Text(String(localized: "Sprachhilfe will start automatically when you log in."))
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
            ...
            Section(String(localized: "Indicator")) {
                ...
                if supportsTranscriptPreview {
                    ...
                    if !dictation.indicatorTranscriptPreviewEnabled {
                        Text(String(localized: "When disabled, Sprachhilfe skips live transcript requests for the indicator and only runs the final transcription after you stop recording."))
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
                }
        ...
        .alert(String(localized: "Restart Required"), isPresented: $showRestartAlert) {
            ...
            Text(String(localized: "The language change will take effect after restarting Sprachhilfe."))
        }
    }
