        ...
        HStack {
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(localizedAppText(
                    "When context X is detected, Sprachhilfe uses behavior Y.",
                    de: "Wenn Kontext X erkannt wird, nutzt Sprachhilfe Verhalten Y."
                ))
                .font(.subheadline)
    ...
    private var emptyState: some View {
        ContentUnavailableView {
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text(localizedAppText(
                    "Rules tell Sprachhilfe which language, engine, or output format should apply in which context.",
                    de: "Regeln erklären Sprachhilfe, wann welche Sprache, Engine oder Ausgabeform gelten soll."
                ))
                Text(localizedAppText(
...
private struct RuleEditorSheet: View {
    ...
    private var stepGuidance: String {
        ...
        case .behavior:
            return localizedAppText("Define how Sprachhilfe should respond in this context.", de: "Lege fest, wie Sprachhilfe in diesem Kontext reagieren soll.")
        case .review:
...
private struct RuleBehaviorStep: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            VStack(alignment: .leading, spacing: 6) {
                Text(localizedAppText("How should Sprachhilfe respond?", de: "Wie soll Sprachhilfe reagieren?"))
                    .font(.title3.weight(.semibold))
                Text(localizedAppText(
            ...
            card(
                ...
                VStack(spacing: 0) {
                    settingRow(
                        ...
                        description: localizedAppText("Which language Sprachhilfe should expect in this context.", de: "Welche Sprache Sprachhilfe in diesem Kontext erwarten soll.")
                    ) {
                    ...
                    if #available(macOS 15, *) {
                        ...
                        settingRow(
                            ...
                            description: localizedAppText("Whether Sprachhilfe should translate the text automatically before inserting it.", de: "Ob Sprachhilfe den Text vor dem Einfügen automatisch übersetzen soll.")
                        ) {
            ...
            card(
                ...
                VStack(spacing: 0) {
                    settingRow(
                        ...
                        description: localizedAppText("Which engine Sprachhilfe should prefer here.", de: "Welche Engine Sprachhilfe hier bevorzugt verwenden soll.")
                    ) {
