...
private enum RichTextClipboardContentFormatter {
    ...
    private static func richTextSource(from text: String) -> String {
        ...
        return removingSprachhilfeBoundaryMarkers(from: source)
    ...
    private static func removingSprachhilfeBoundaryMarkers(from text: String) -> String {
        normalizeNewlines(text)
            ...
            .filter { line in
                let normalizedLine = line
                    .trimmingCharacters(in: .whitespacesAndNewlines)
                    .uppercased()
                return normalizedLine != "BEGIN SPRACHHILFE DICTATED TEXT"
                    && normalizedLine != "END SPRACHHILFE DICTATED TEXT"
            }
            .joined(separator: "\n")
    }
