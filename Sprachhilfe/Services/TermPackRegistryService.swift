...
private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Sprachhilfe", category: "TermPackRegistry")
...
final class TermPackRegistryService: ObservableObject {
    ...
    init(
        registryURL: URL = URL(string: "https://tamaga3131400.github.io/sprachhilfe/termpacks.json")!,
