...
enum IndicatorFullscreenSuppressionPolicy {
    ...
    static func shouldSuppressIndicator(
        ...
        guard safeAreaTopInset > 0,
              ...
              !isSprachhilfeBundleIdentifier(frontmostBundleIdentifier, appBundleIdentifier: appBundleIdentifier) else {
            return false
        }
    ...
    private static func isSprachhilfeBundleIdentifier(
        ...
        return bundleIdentifier == "com.sprachhilfe.mac"
            || bundleIdentifier == "com.sprachhilfe.mac.dev"
    }
