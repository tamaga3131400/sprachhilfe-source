...
private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Sprachhilfe", category: "TextInsertionService")
...
final class TextInsertionService {
    ...
    func insertText(
        ...
        pasteboard.setData(Data(), forType: .init("com.sprachhilfe.SpeechTranscription"))
        logger.info(
