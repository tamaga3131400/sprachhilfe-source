...
var apiTokenOverride = ProcessInfo.processInfo.environment["SPRACHHILFE_API_TOKEN"]
...
func printUsage() {
    let usage = """
        Usage: sprachhilfe <command> [options]
        ...
        Global options:
          ...
          --dev                Connect to Sprachhilfe Dev instance
          --json               Output as JSON
          --help, -h           Show help
        ...
        Examples:
          sprachhilfe status
          sprachhilfe transcribe recording.wav
          ...
          sprachhilfe transcribe recording.wav --model whisper-large-v3-turbo
          sprachhilfe transcribe recording.wav --engine groq
          sprachhilfe transcribe recording.wav --engine groq --model whisper-large-v3-turbo
          sprachhilfe transcribe - < audio.wav
